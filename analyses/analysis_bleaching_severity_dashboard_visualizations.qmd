---
title: "WCS MERMAID Bleaching Severity Dashboard Visualizations"
...
This code provides examples of visualizations on the MERMAID dashboard ([https://dashboard.datamermaid.org](https://dashboard.datamermaid.org/)) that show information about bleaching severity (from the bleaching protocol).
