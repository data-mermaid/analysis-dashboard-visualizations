---
title: "WCS MERMAID Habitat Complexity Dashboard Visualizations"
...
This code provides examples of visualizations shown on the MERMAID dashboard ([https://dashboard.datamermaid.org](https://dashboard.datamermaid.org/)) that focus on the habitat complexity protocol.
...
```{r}
#| label: Simple scale plot - Average habitat complexity score for a single survey
